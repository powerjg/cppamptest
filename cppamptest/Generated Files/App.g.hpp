...
void ::cppamptest::App::InitializeComponent()
{
#if defined _DEBUG && !defined DISABLE_XAML_GENERATED_BREAK_ON_UNHANDLED_EXCEPTION
...
::Windows::UI::Xaml::Markup::IXamlType^ ::cppamptest::App::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
...
::Windows::UI::Xaml::Markup::IXamlType^ ::cppamptest::App::GetXamlType(::Platform::String^ fullName)
{
    if(_provider == nullptr)
    {
        _provider = ref new XamlTypeInfo::InfoProvider::XamlTypeInfoProvider();
...
::Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::cppamptest::App::GetXmlnsDefinitions()
{
...
int __cdecl main(::Platform::Array<::Platform::String^>^ args)
{
    ...
    ::Windows::UI::Xaml::Application::Start(ref new ::Windows::UI::Xaml::ApplicationInitializationCallback(
        [](::Windows::UI::Xaml::ApplicationInitializationCallbackParams^ p) {
            ...
            auto app = ref new ::cppamptest::App();
        }));
}
#endif
